...
export default function EnquiriesTable() {
  ...
  const API_URL = `${baseURL}/enquiry/all`;
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-lg">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm">Fetched all Contact Enquiries</p>
      </div>
      {loading ? (
              ...
              {enquiries.map((enquiry) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 max-w-[500px]">
                    {enquiry.service && enquiry.service.length > 0
                      ? enquiry.service.join(", ")
                      : "-"}
                  </td>
