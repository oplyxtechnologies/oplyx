...
const Testimonials: React.FC = () => {
  return (
    <div className="bg-primary my-10 text-white">
          ...
          <Carousel>
            <CarouselContent>
              {testimonialsData.map((testimonial) => (
                ...
                >
                  <div className="p-6 rounded-lg bg-secondary text-primary shadow-lg">
                    <Image
                      className="bg-primary rounded-xl mb-5 bg-opacity-30 text-secondary p-4"
                      alt="quote"
                      src="/quot.svg"
                      width={70}
                      height={24}
